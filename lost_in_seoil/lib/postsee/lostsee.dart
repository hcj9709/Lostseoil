                               ...
                               Navigator.push(context, MaterialPageRoute(
                                   builder: (context) =>
                                       Writeupdate(name: widget.name,
                                           student_id: widget.student_id, LostIndex: widget.LostIndex,))).then((value){
                                                        ...
                                                        Container(
                                                          ...
                                                          child:Row(
                                                              ...
                                                              children:[
                                                                ...
                                                                if((widget.student_id.toString())==(Commentsstudent_id[index].toString()))...[
                                                                  PopupMenuButton(
                                                                    padding: EdgeInsets.fromLTRB(5,0,3, 7),
