    ...
    return
      WillPopScope(
          onWillPop: () {
            ...
            if (backButton) {
              Fluttertoast.showToast(msg: "한번더 누르시면 로그아웃 됩니다.",
                  backgroundColor: Colors.lightBlue,gravity: ToastGravity.BOTTOM,
                  toastLength: Toast.LENGTH_SHORT,fontSize: 16);
            ...
            child:Column(
              children:  <Widget>[
                ...
                Container(
                  ...
                  height: MediaQuery.of(context).size.height *0.07,width: double.infinity,
                  child: Row(
                    ...
                    children: [
                      ...
                      Flexible(
                        ...
                        child:
                        TextButton(
                            onPressed: (){Navigator.push(context,MaterialPageRoute(builder:(context)=> GetPage(name: widget.name ,student_id: widget.student_id )));
                            print("check");
                              }
                            ,
                            child: const Text('습득물',style: TextStyle(fontSize:20,color: Colors.white),),
                            style: ButtonStyle(
                      ...
                      children:   [
                        ...
                        Flexible(
                          ...
                          child: ElevatedButton( onPressed: () {
                            print("글쓰기");
                            Navigator.push(context,MaterialPageRoute(builder:(context)=>   Lostwrite(name: widget.name,student_id: widget.student_id)));
                            print("check");
