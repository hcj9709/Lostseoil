                              ...
                              children:[
                                ListTile(
                                  ...
                                  trailing: Chip(
                                    ...
                                    Text('완료', style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),textAlign: TextAlign.center)
                                           ]else...[
                                       Text('미완료', style: TextStyle(color: Colors.white,fontSize: 12,fontWeight: FontWeight.bold))
                                                ]                   
                                      ]
                                    ,
                                      ),
