...
class Chatstart extends State<mychat> {
  ...
  */
    ...
    socket.on('chatData',(data){ //받아온 데이터가 들어감
    ...
    socket.on('chat', (message) {
      ...
      print("i 값 "+i.toString());

      setState(() {
       MessagesModel.messages.add(message[i-1]);
      });
    });
           ...
           Positioned(
             ...
             child: ListView.builder(
               ...
               itemBuilder: (BuildContext context, int index) {
                 ...
                 return (message['userid'].toString() == widget.student_id.toString() )
                     ? Column(
                      children:[
                         Row(
