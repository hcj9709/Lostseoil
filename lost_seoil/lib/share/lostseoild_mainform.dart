...
import 'package:lost_seoil/share/dropdownbutton.dart';
          ...
          ,
                Column(
                  ...
                  Align(
                   ...
                   child: TextButton.icon(onPressed: (){Navigator.push(context,MaterialPageRoute(builder:(context)=> const Mygetfilter()));}, icon:  const Icon(Icons.tune,), label: const Text("필터"),)
                  )
                  ],
